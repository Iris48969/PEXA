...
def open_parameter_window():
    ...
    def save_parameters(ratio_upper, ratio_lower, multiplier, sensitivity, contamination):
        ...
        parameters.extend([ratio_upper, ratio_lower, multiplier, sensitivity, contamination])
    ...
    default_button.grid(row=5, column=0, pady=10, padx=10)
